...
\cventry{2025}{Participated at the cycle \href{"Un texte, une aventure mathématique"}{https://smf.emath.fr/node/28305}}{Lycée international St Germain en Laye}{city}{}{Description: Gave a ''pre-talk'' at a high school preparing for the talk ["Dennis Sullivan, mathématicien des analogies"](https://smf.emath.fr/evenements-smf/conference-bnf-b-schapira-2025) given by Barbara Schapira. "Un texte, une aventure mathématique" is a joint organization of the [Société Mathématique de France](https://smf.emath.fr/) and the [Bibliothèque nationale de France](http://www.bnf.fr/fr/acc/x.accueil.html) to expose the general public with the history and problems of current research Mathematics.}
